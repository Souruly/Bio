function Bird(x,y)
{
  ...
  this.alignMultiplier = 1.0;
  this.obstacleSeperation = this.r*20;
  this.obstacleMultiplier = 5.0;
  ...
  this.applyBehaviours = function(birds,obstacles)
  {
      ...
      align.mult(this.alignMultiplier);
      attract.mult(this.attractionMultiplier);
      seperate.mult(this.separationMultiplier);
      repel.mult(this.obstacleMultiplier);
  ...
  this.repulsion = function(obstacles)
  {
    ...
    for(var i=0 ; i<obstacles.length ; i++)
    {
      ...
      if(d>0 && d<this.obstacleSeperation)
      {
